---
title: "OpenTray v0.27~0.28: Multi-WebView layout in one window, the WebView-Navigation-API, kernel performance work"
...
![The wizard's Advanced options panel expanded, showing four switches: show startup terminal, navigation toolbar, image smoothing, allow developer mode. The navigation toolbar switch is off, and its hint says the app composes a native navigation toolbar at the top of the window.](/blog-assets/2026-09-16-opentray-v0-27-v0-28/wizard-toolbar-toggle.en.png)
...
![The wizard's language menu open, listing nine entries from top to bottom: 简体中文, 日本語, 한국어, English, العربية, Français, Español, Deutsch, Русский. Below the menu sits the Language button, showing the label EN.](/blog-assets/2026-09-16-opentray-v0-27-v0-28/wizard-languages.en.png)
...
- Chinese version: [/zh/blog/2026-09-16-opentray-v0-27-v0-28/](/zh/blog/2026-09-16-opentray-v0-27-v0-28/)
