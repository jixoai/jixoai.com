...
export const ar: Dictionary = {
  ...
  projectDescriptions: {
    ...
    'skill-creator':
      'منضدة عمل محلية أولاً لمهارات الوكلاء — واجهة سطر أوامر وواجهة رسومية في شريط النظام تديران دورة حياة المهارات، وخادم MCP يتيح القدرات نفسها للوكلاء الخارجيين، ونواة DSH بلا واجهة تشغّل جلسات التطبيق.',
  },
