...
export const ru: Dictionary = {
  ...
  projectDescriptions: {
    ...
    'skill-creator':
      'Локальная мастерская скиллов для агентов — CLI и GUI в трее управляют жизненным циклом скиллов, MCP-сервер отдаёт те же возможности внешним агентам, а headless-ядро DSH ведёт сессии внутри приложения.',
  },
