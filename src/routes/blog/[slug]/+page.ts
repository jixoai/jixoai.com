...
// the build-time discovered post map; markdown bodies segmented for
// the registry <Markdown> component (first-party content, no
// sanitization by spec; ```spin fences become live-demo blocks); prerender enumeration —
...
export const load: PageLoad = ({ params }) => {
  ...
  return { post, segments: splitLiveDemos(post.markdown) };
};
